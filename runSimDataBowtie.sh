...
bowtie -n 0 -k 10 -f --al 'DataSet'$var'_'$params'_al.map' --un 'DataSet'$var'_'$params'_un.map' --max 'DataSet'$var'_'$params'_max.map' 'DataSet'$var'Index' 'DataSet'$var'Reads.fa' 'DataSet'$var'_'$params'.map'
