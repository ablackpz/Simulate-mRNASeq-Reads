...
# Usage: python getTranscriptReadCountsFromTranscriptMapping.py bowtie.input.map.bowtie bowtie.input.map.actual output.bowtie.txt output.actual.txt
...
groups = makeRandomTestData.inputSimilarGroupsSpaceDelim(groups, infileGroups)
